...
// Hardcoded User for MGM
const currentUserMGM = {
  name: 'Dr. Ramesh Kumar',
  organizationName: 'MGM Healthcare'
};

// Main Dashboard Component for MGM
const HospitalDashboardMGM = () => {
  const [incidents, setIncidents] = useState([
    {
      ...
      isRead: false,
      description: 'Car and Truck collision',
    ...
    },
    {
      ...
      isRead: false,
      description: 'A truck collision resulting in fire.',
      coordinates: { lat: 13.0566, lng: 80.2631 },
      detectedBy: 'CCTV Camera #056'
    },
    {
      id: 4,
      location: '27, Valluvar Kottam High Road, Nungambakkam, Chennai',
      timestamp: '2025-05-01T08:40:00Z',
      severity: 'Low',
      status: 'accepted',
      image: null,
      isRead: true,
    ...
    {
      id: 5,
      location: '90, Jawaharlal Nehru Road, Koyambedu, Chennai',
      timestamp: '2025-04-30T19:15:00Z',
      severity: 'High',
      status: 'pending',
  ...
  const handleAcceptIncident = (incidentId) => {
    setIncidents(prev => prev.map(i =>
      i.id === incidentId ? { ...i, status: 'accepted', respondingHospital: currentUserMGM.organizationName } : i
    ));
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-16 items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-right">
              <div className="text-base font-medium text-gray-800">{currentUserMGM.name}</div>
              <div className="text-sm text-gray-500">{currentUserMGM.organizationName}</div>
            </div>
                ...
                <div key={incident.id} className="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
                  ...
                  <div className="px-4 py-4 sm:px-6">
                    ...
                    <button
                      ...
                      className="mt-4 flex items-center justify-center px-4 py-2 text-sm text-gray-700 bg-gray-50 hover:bg-gray-100 rounded-md border"
                    >
...
export default HospitalDashboardMGM;
